...
/**
 * wsdl processor implementation
 */
public class WSDLSOAPOperationMapper implements WSDLProcessor {
    private static final Logger log = LoggerFactory.getLogger(WSDLSOAPOperationMapper.class);
        ...
        try {
            ...
            for(Object ext : typeList) {
                if(ext instanceof Schema) {
                    ...
                    String nodeNS = nodeName.split(":")[0];
    ...
    /**
     * gets address uri for a soap element
     *
     * @param exElement extensibility element
     * @return address uri
     * @throws APIMgtWSDLException
     */
